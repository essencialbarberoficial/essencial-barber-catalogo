...
function renderizarPedido(pedido) {
  ...
  container.innerHTML = `
    ...
    <div class="card-panel">
      ...
      ${pedido.codigoRastreio ? `<p style="text-align:center; font-size:13px; color:var(--text-muted);">Código de rastreio: <strong>${escapeHtml(pedido.codigoRastreio)}</strong></p>` : ''}
